...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-terracoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-terracoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-terracoin -o bitcore-lib-terracoin.js';
    }
